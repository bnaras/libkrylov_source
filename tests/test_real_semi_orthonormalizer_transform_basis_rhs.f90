program test_real_semi_orthonormalizer_transform_basis_rhs
    ...
    real(RK) :: vectors(4_IK, 2_IK), basis_rhs(2_IK, 2_IK), orthonormalized(2_IK, 2_IK), &
    ...
    orthonormalized_ref = reshape((/1.0_RK, 9.0_RK, 1.0_RK, 14.0_RK/), (/2_IK, 2_IK/))
...
end program test_real_semi_orthonormalizer_transform_basis_rhs
