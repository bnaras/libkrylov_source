program test_get_space_preconditioner
    ...
    preconditioner = krylov_get_space_preconditioner(1_IK)
    ...
    preconditioner = krylov_get_space_preconditioner(2_IK)
    if (preconditioner /= 'n') stop 1
    ...
    ! preconditioner = krylov_get_space_preconditioner(3_IK)
