program test_complex_eigenvalue_equation_expand_equation
    ...
    complex(CK) :: vectors(3_IK, 2_IK), products(3_IK, 2_IK), rayleigh(2_IK, 2_IK)
    integer(IK) :: error
    ...
    products = reshape((/(1.0_CK, 0.1_CK), (1.0_CK, 0.1_CK), (0.0_CK, 0.0_CK), (1.0_CK, 0.1_CK), &
                         (-1.0_CK, -0.1_CK), (0.0_CK, 0.0_CK)/), (/3_IK, 2_IK/))
    rayleigh = reshape((/(1.01_CK, 0.0_CK), (1.01_CK, 0.0_CK), (1.01_CK, 0.0_CK), (-1.01_CK, 0.0_CK)/), &
                       (/2_IK, 2_IK/))
...
end program test_complex_eigenvalue_equation_expand_equation
