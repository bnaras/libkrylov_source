program test_complex_linear_equation_solve_projected
    ...
    rayleigh = reshape((/(1.0_CK, 0.0_CK), (1.0_CK, 0.1_CK), (1.0_CK, -0.1_CK), (-1.0_CK, 0.0_CK)/), (/2_IK, 2_IK/))
    basis_rhs = reshape((/(1.0_CK, 0.1_CK), (0.0_CK, 0.0_CK), (0.0_CK, 0.0_CK), (1.0_CK, 0.1_CK)/), (/2_IK, 2_IK/))
    basis_solutions = reshape((/(0.5_CK, 0.0_CK), (0.49_CK, 0.099_CK), (0.5_CK, 0.0_CK), &
                                (-0.49_CK, -0.099_CK)/), (/2_IK, 2_IK/))
    ...
    if (equation%basis_solutions /= near_complex_mat(basis_solutions, thr=1.0E-01_RK)) stop 1
