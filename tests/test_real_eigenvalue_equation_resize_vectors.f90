program test_real_eigenvalue_equation_resize_vectors
    ...
    real(RK) :: vectors(6_IK, 2_IK), vectors_ref(6_IK, 4_IK), vectors_ref1(6_IK, 2_IK)
    integer(IK) :: error

    vectors = reshape((/1.0_RK, 0.0_RK, 0.0_RK, 0.0_RK, 0.0_RK, 0.0_RK, &
                        0.0_RK, 1.0_RK, 0.0_RK, 0.0_RK, 0.0_RK, 0.0_RK/), (/6_IK, 2_IK/))
    vectors_ref = reshape((/1.0_RK, 0.0_RK, 0.0_RK, 0.0_RK, 0.0_RK, 0.0_RK, &
                            0.0_RK, 1.0_RK, 0.0_RK, 0.0_RK, 0.0_RK, 0.0_RK, &
                            0.0_RK, 0.0_RK, 0.0_RK, 0.0_RK, 0.0_RK, 0.0_RK, &
                            0.0_RK, 0.0_RK, 0.0_RK, 0.0_RK, 0.0_RK, 0.0_RK/), (/6_IK, 4_IK/))
    vectors_ref1 = 0.0_RK
    ...
    if (equation%vectors /= near_real_mat(vectors_ref)) stop 1
    ...
    if (equation%vectors /= near_real_mat(vectors_ref1)) stop 1

end program test_real_eigenvalue_equation_resize_vectors
