program test_get_space_eigenvalue_size
    ...
    length = krylov_get_space_eigenvalue_size(index + 1_IK)
    ...
    ! Get size of space with incompatible equation
    length = krylov_get_space_eigenvalue_size(index)
...
end program test_get_space_eigenvalue_size
