program test_complex_shifted_linear_equation_get_expectation_vals
    ...
    real(RK) :: expectation_vals(2_IK), expectation_vals_ref(2_IK)
    integer(IK) :: error
    ...
    expectation_vals_ref = (/-2.01_RK, 1.99_RK/)
...
end program test_complex_shifted_linear_equation_get_expectation_vals
