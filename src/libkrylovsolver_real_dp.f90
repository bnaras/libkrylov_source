...
!--------------------------------------------------------------------
!< Description:
!< This module wraps solvers in libkrylovsolver,
!< hiding compile-time polymorphism
!--------------------------------------------------------------------
!
!--------------------------------------------------------------------
...
!--------------------------------------------------------------------
!--------------------------------------------------------------------
  subroutine problem_a_solver_real_dp(krylov_approx,krylov_start,&
    & krylov_problem_a,&
...
!--------------------------------------------------------------------
!--------------------------------------------------------------------
  end subroutine problem_a_solver_real_dp
!--------------------------------------------------------------------
!--------------------------------------------------------------------

!--------------------------------------------------------------------
!--------------------------------------------------------------------
  subroutine problem_b_solver_real_dp(krylov_approx,krylov_start,&
    & krylov_rhs,&
...
!--------------------------------------------------------------------
    ...
    call problem_b_solver(krylov_approx,krylov_start,&
    & krylov_rhs,&
    & krylov_problem_b,krylov_guess,&
    & krylov_mvp,krylov_precon,krylov_output_b,ierr)
...
!--------------------------------------------------------------------
!--------------------------------------------------------------------
  end subroutine problem_b_solver_real_dp
!--------------------------------------------------------------------
!--------------------------------------------------------------------

!--------------------------------------------------------------------
!--------------------------------------------------------------------
  subroutine problem_c_solver_real_dp(krylov_approx,krylov_start,&
    & krylov_rhs,krylov_omega,krylov_problem_c,krylov_guess,&
...
! Description:
!--------------------------------------------------------------------
!< This subroutine solves a problem with the form 'problem_c'
!< with the non-orthonormal krylov subspace method
...
!--------------------------------------------------------------------
    ...
    call problem_c_solver(krylov_approx,krylov_start,&
    & krylov_rhs,krylov_omega,krylov_problem_c,krylov_guess,&
    & krylov_mvp,krylov_precon,krylov_output_c,ierr)

!--------------------------------------------------------------------
!------------------------------------------:--------------------------
  end subroutine problem_c_solver_real_dp
!--------------------------------------------------------------------
!--------------------------------------------------------------------
!--------------------------------------------------------------------
!--------------------------------------------------------------------
