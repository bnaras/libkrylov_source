function krylov_complex_jdall_preconditioner_initialize(preconditioner, full_dim, solution_dim, config) result(error)
    ...
    preconditioner%solutions = (0.0_CK, 0.0_CK)
