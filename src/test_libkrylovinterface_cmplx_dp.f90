!--------------------------------------------------------------------
!--------------------------------------------------------------------
program test_libkrylovinterface_cmplx_dp
!--------------------------------------------------------------------
!--------------------------------------------------------------------
!
!--------------------------------------------------------------------
...
! basis vectors
  complex(lkl_double_k), allocatable :: basis_vectors(:,:)
! frequencies
...
!! define fname
  fname = 'cmplx_dp_interface_test.out'
...
!! printing test results as they run
  ...
  write(unit=funit,fmt=*) 'type complex, double precision elements'
...
!--------------------------------------------------------------------
!--------------------------------------------------------------------
end program test_libkrylovinterface_cmplx_dp
!--------------------------------------------------------------------
!--------------------------------------------------------------------
