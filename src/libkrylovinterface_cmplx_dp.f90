...
!--------------------------------------------------------------------
    integer(lkl_int_k) :: j,k = 0
    complex(lkl_double_k) :: numerator
    complex(lkl_double_k) :: denominator
    complex(lkl_double_k), external :: zdotc
    complex(lkl_double_k), allocatable :: mx(:,:)
!--------------------------------------------------------------------
...
!--------------------------------------------------------------------
    ...
    complex(lkl_double_k) :: numerator
    complex(lkl_double_k) :: denominator
    complex(lkl_double_k), external :: ddot
    complex(lkl_double_k), allocatable :: mx(:,:)
!--------------------------------------------------------------------
