function krylov_get_real_block_vectors(num_spaces, total_size, full_dims, subset_dims, offsets, vectors) result(error)
    ...
    use krylov, only: spaces, real_space_t, krylov_get_num_spaces, krylov_get_real_space_subset_vectors
    implicit none
    ...
    do index = 1_IK, num_spaces
        ...
        type is (real_space_t)
            ...
            err = krylov_get_real_space_subset_vectors(index, space%full_dim, skip_dim, subset_dim, &
