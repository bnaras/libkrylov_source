...
#  make install-real_sp_krylovtypePROGRAMS
...
#  make install-cmplx_sp_krylovtypePROGRAMS
...
#  make install-real_dp_krylovtypePROGRAMS
...
#  make install-cmplx_dp_krylovtypePROGRAMS
