function krylov_set_complex_block_products(num_spaces, total_size, full_dims, subset_dims, offsets, products) result(error)
    ...
    use krylov, only: spaces, complex_space_t, krylov_get_num_spaces, krylov_set_complex_space_subset_products
    implicit none
    ...
    do index = 1_IK, num_spaces
        ...
        type is (complex_space_t)
            ...
            err = krylov_set_complex_space_subset_products(index, space%full_dim, skip_dim, subset_dim, &
