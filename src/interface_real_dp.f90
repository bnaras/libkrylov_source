...
!--------------------------------------------------------------------
  ...
  &   libkrylov_problem_a_input => libkrylov_problem_a_real_dp, &
  &   libkrylov_problem_a_output => libkrylov_output_a_real_dp, &
  &   libkrylov_problem_b_input => libkrylov_problem_b_real_dp, &
  &   libkrylov_problem_b_output => libkrylov_output_b_real_dp, &
  &   libkrylov_problem_c_input => libkrylov_problem_c_real_dp, &
  &   libkrylov_problem_c_output => libkrylov_output_c_real_dp
!--------------------------------------------------------------------
! Implicit none
!--------------------------------------------------------------------
!
