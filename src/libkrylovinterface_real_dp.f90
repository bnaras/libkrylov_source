...
!!    columns of obj
      integer(lkl_int_k), intent(in) :: n2
!!    obj to be interacted with
      real(lkl_double_k), intent(inout) :: obj(n1,n2)
      integer(lkl_int_k), intent(inout) :: ierr
...
!!    approximate spectra
      real(lkl_double_k), intent(in) :: approx_spectra(n1)
!!    guess vectors
      real(lkl_double_k), intent(inout) :: basis_vectors(n1,n2)
!!    error variable
      integer(lkl_int_k), intent(inout) :: ierr
...
!!    desired matrix vector products, mvproducts
      real(lkl_double_k), intent(inout) :: mvproduct(n1,n2)
!!    error variable
      integer(lkl_int_k), intent(inout) :: ierr
...
!!    array for which solutions are converged
      logical, intent(in) :: jconverged(n3)
!!    rhs
      real(lkl_double_k), intent(in) :: rhs(n1,n3)
!!    functional
      real(lkl_double_k), intent(in) :: lagrangian(n3)
!!    solutions on the full space, stored on mvproduct
      real(lkl_double_k), intent(in) :: solutions(n1,n3)
...
!!    rhs
      real(lkl_double_k), intent(in) :: rhs(n1,n4)
!!    lagrangian
      real(lkl_double_k), intent(in) :: lagrangian(n5)
!!    solutions on the full space, stored on mvproduct
      real(lkl_double_k), intent(in) :: solutions(n1,n5)
!!    residual norms of each vector
