...
!--------------------------------------------------------------------
!--------------------------------------------------------------------
  subroutine problem_b_real_sp(krylov_approx,krylov_start,krylov_rhs,&
...
!--------------------------------------------------------------------
    class(libkrylov_vector_real_sp) ::    krylov_approx
    class(libkrylov_start_real_sp) ::     krylov_start
    class(libkrylov_matrix_real_sp) ::    krylov_rhs
    class(libkrylov_problem_b_real_sp) :: krylov_problem_b
    class(libkrylov_guess_real_sp) ::     krylov_guess
    class(libkrylov_mvp_real_sp) ::       krylov_mvp
    class(libkrylov_output_b_real_sp) ::  krylov_output_b
!! variable for error variable
    integer(lkl_int_rsp_k), intent(inout) :: ierr
!--------------------------------------------------------------------
...
!--------------------------------------------------------------------
!--------------------------------------------------------------------
  end subroutine problem_b_real_sp
!--------------------------------------------------------------------
!--------------------------------------------------------------------

!--------------------------------------------------------------------
!--------------------------------------------------------------------
  subroutine problem_c_real_sp(krylov_approx,krylov_start,krylov_rhs,&
...
!--------------------------------------------------------------------
    ...
    class(libkrylov_start_real_sp) ::     krylov_start
    class(libkrylov_matrix_real_sp) ::    krylov_rhs
    class(libkrylov_vector_real_sp) ::    krylov_omega
    class(libkrylov_problem_c_real_sp) :: krylov_problem_c
    class(libkrylov_guess_real_sp) ::     krylov_guess
    class(libkrylov_mvp_real_sp) ::       krylov_mvp
    class(libkrylov_output_c_real_sp) ::  krylov_output_c
!! variable for error variable
    integer(lkl_int_rsp_k), intent(inout) :: ierr
!--------------------------------------------------------------------
...
!--------------------------------------------------------------------
!--------------------------------------------------------------------
  end subroutine problem_c_real_sp
!--------------------------------------------------------------------
!--------------------------------------------------------------------
