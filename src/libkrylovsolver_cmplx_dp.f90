...
!--------------------------------------------------------------------
!--------------------------------------------------------------------
  subroutine problem_a_cmplx_dp(krylov_approx,krylov_start,&
    & krylov_problem_a,&
...
! Input functions
!--------------------------------------------------------------------
    class(libkrylov_vector_cmplx_dp) ::    krylov_approx
    class(libkrylov_start_cmplx_dp) ::     krylov_start
    class(libkrylov_problem_a_cmplx_dp) :: krylov_problem_a
    class(libkrylov_guess_cmplx_dp) ::     krylov_guess
    class(libkrylov_mvp_cmplx_dp) ::       krylov_mvp
    class(libkrylov_output_a_cmplx_dp) ::  krylov_output_a
...
!--------------------------------------------------------------------
!--------------------------------------------------------------------
  end subroutine problem_a_cmplx_dp 
!--------------------------------------------------------------------
!--------------------------------------------------------------------

!--------------------------------------------------------------------
!--------------------------------------------------------------------
  subroutine problem_b_cmplx_dp(krylov_approx,krylov_start,krylov_rhs,&
...
!--------------------------------------------------------------------
    class(libkrylov_vector_cmplx_dp) ::    krylov_approx
    class(libkrylov_start_cmplx_dp) ::     krylov_start
    class(libkrylov_matrix_cmplx_dp) ::    krylov_rhs
    class(libkrylov_problem_b_cmplx_dp) :: krylov_problem_b
    class(libkrylov_guess_cmplx_dp) ::     krylov_guess
    class(libkrylov_mvp_cmplx_dp) ::       krylov_mvp
    class(libkrylov_output_b_cmplx_dp) ::  krylov_output_b
!! variable for error variable
    integer(lkl_int_cdp_k), intent(inout) :: ierr
!--------------------------------------------------------------------
...
!--------------------------------------------------------------------
!--------------------------------------------------------------------
  end subroutine problem_b_cmplx_dp
!--------------------------------------------------------------------
!--------------------------------------------------------------------

!--------------------------------------------------------------------
!--------------------------------------------------------------------
  subroutine problem_c_cmplx_dp(krylov_approx,krylov_start,krylov_rhs,&
...
!--------------------------------------------------------------------
    ...
    class(libkrylov_start_cmplx_dp) ::     krylov_start
    class(libkrylov_matrix_cmplx_dp) ::    krylov_rhs
    class(libkrylov_vector_cmplx_dp) ::    krylov_omega
    class(libkrylov_problem_c_cmplx_dp) :: krylov_problem_c
    class(libkrylov_guess_cmplx_dp) ::     krylov_guess
    class(libkrylov_mvp_cmplx_dp) ::       krylov_mvp
    class(libkrylov_output_c_cmplx_dp) ::  krylov_output_c
!! variable for error variable
    integer(lkl_int_cdp_k), intent(inout) :: ierr
!--------------------------------------------------------------------
...
!--------------------------------------------------------------------
!--------------------------------------------------------------------
  end subroutine problem_c_cmplx_dp
!--------------------------------------------------------------------
!--------------------------------------------------------------------
