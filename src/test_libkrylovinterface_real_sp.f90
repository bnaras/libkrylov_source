!--------------------------------------------------------------------
!--------------------------------------------------------------------
program test_libkrylovinterface_real_sp
!--------------------------------------------------------------------
!--------------------------------------------------------------------
!
!--------------------------------------------------------------------
...
! basis vectors
  real(lkl_single_k), allocatable :: basis_vectors(:,:)
! frequencies
  real(lkl_single_k), allocatable :: precon_roots(:)
! residuals
  real(lkl_single_k), allocatable :: residuals(:,:)
! full solutions
  real(lkl_single_k), allocatable :: full_solutions(:,:)
!--------------------------------------------------------------------
...
!! define fname
  fname = 'real_sp_interface_test.out'
...
!! printing test results as they run
  ...
  write(unit=funit,fmt=*) 'type real, single precision elements'
...
!--------------------------------------------------------------------
!--------------------------------------------------------------------
end program test_libkrylovinterface_real_sp
!--------------------------------------------------------------------
!--------------------------------------------------------------------
