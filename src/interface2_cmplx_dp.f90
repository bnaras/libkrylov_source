...
!--------------------------------------------------------------------
  ...
  &   lkl_constr_a_1 => lkl_constr_a_1_cdp, &
  &   lkl_destr_a_1 => lkl_destr_a_1_cdp, &
  &   lkl_constr_b_1 => lkl_constr_b_1_cdp, &
  &   lkl_destr_b_1 => lkl_destr_b_1_cdp, &
  &   lkl_constr_c_1 => lkl_constr_c_1_cdp, &
  &   lkl_destr_c_1 => lkl_destr_c_1_cdp, &
  ...
  &   lkl_mvp_n_mul => lkl_mvp_n_mul_cdp, &
  &   lkl_mvp_naive_multiply => lkl_mvp_naive_multiply_cdp
!--------------------------------------------------------------------
! Implicit none
!--------------------------------------------------------------------
!
