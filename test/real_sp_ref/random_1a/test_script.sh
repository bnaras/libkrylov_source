...
echo ' libkrylov/src/real_sp_test/problem1a_rand_real_sp' >> ../testing.summary
../../../src/real_sp_test/problem1a_rand_real_sp
#echo 'comparing to exact solutions' >> ../testing.summary
#sed '7,11!d' real_sp_1a_exact_vals.raft >> ../testing.summary
echo '' >> ../testing.summary
...
echo 'test/real_sp_testing.results/random_1a/real_sp_npc_driver1a.out' >> ../testing.summary
...
echo 'test output in' >> ../testing.summary
echo 'test/real_sp_testing.results/random_1a/real_sp_apc_driver1a.out' >> ../testing.summary
...
echo 'test output in' >> ../testing.summary
echo 'test/real_sp_testing.results/random_1a/real_sp_dpc_driver1a.out' >> ../testing.summary
...
echo '' >> ../testing.summary
echo '~~~~~Real Single random_a test done~~~~~'
