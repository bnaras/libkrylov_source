...
echo '' >> ../testing.summary
rm kill.libkrylov
mv real_sp_a_restart_0.out real_sp_a_restart_0.out.old
...
rm real_sp_1a_vals.json
rm real_sp_1a_vecs.json
mv real_sp_a_restart_1.out real_sp_a_restart_1.out.old
echo 'restart level 1' >> ../testing.summary
echo 'test output in' >> ../testing.summary
...
sed '7,11!d' real_sp_1a_1_vals.json >> ../testing.summary
echo '' >> ../testing.summary
echo 'generating restart files for' >> ../testing.summary
echo 'restart levels' >> ../testing.summary
echo 'test output in' >> ../testing.summary
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv real_sp_a_restart_2.out real_sp_a_restart_2.out.old
...
echo 'eigenvalues:' >> ../testing.summary
sed '7,11!d' real_sp_1a_2_vals.json >> ../testing.summary
echo '' >> ../testing.summary
echo 'generating restart files for' >> ../testing.summary
echo 'restart levels' >> ../testing.summary
echo 'test output in' >> ../testing.summary
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv real_sp_a_restart_3.out real_sp_a_restart_3.out.old
...
echo 'eigenvalues:' >> ../testing.summary
sed '7,11!d' real_sp_1a_3_vals.json >> ../testing.summary
echo '' >> ../testing.summary
