...
#
echo '~~~test_solve_from_huckel_problem_a~~~' >> ../testing.summary
echo '' >> ../testing.summary
echo 'using libkrylov/src/real_sp_test/driver1a_real_sp'  >> ../testing.summary
echo 'on huckel matrix problem made by'  >> ../testing.summary
echo ' libkrylov/src/real_sp_test/problem1a_hk_real_sp' >> ../testing.summary
../../../src/real_sp_test/problem1a_hk_real_sp
...
echo 'solve huckel problem with no preconditioner' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/real_sp_testing.results/huckel_1a/real_sp_npc_driver1a.out' >> ../testing.summary
...
mv real_sp_1a_allr.json real_sp_1a_npc_allr.json
...
echo 'all relevant roots' >> ../testing.summary
sed '7,11!d' real_sp_1a_npc_allr.json >> ../testing.summary
echo '' >> ../testing.summary
mv real_sp_apc_driver1a.out real_sp_apc_driver1a.out.old
echo 'solve huckel problem with approximate spectra preconditioner' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/real_sp_testing.results/huckel_1a/real_sp_apc_driver1a.out' >> ../testing.summary
...
echo 'eigenvalues' >> ../testing.summary
sed '7,11!d' real_sp_1a_apc_vals.raft >> ../testing.summary
echo '' >> ../testing.summary
mv real_sp_dpc_driver1a.out real_sp_dpc_driver1a.out.old
echo 'solve huckel problem with davidson preconditioner' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/real_sp_testing.results/huckel_1a/real_sp_dpc_driver1a.out' >> ../testing.summary
...
echo '' >> ../testing.summary
echo '~~~~~Real Single huckel_a test done~~~~~'
