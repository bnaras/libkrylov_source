...
echo 'on pascal matrix problem made by'  >> ../testing.summary
echo ' libkrylov/src/real_sp_test/problem1a_ps_real_sp' >> ../testing.summary
../../../src/real_sp_test/problem1a_ps_real_sp
...
echo 'solve pascal problem with no preconditioner' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/real_sp_testing.results/vandermonde_1a/real_sp_npc_driver1a.out' >> ../testing.summary
...
echo 'solve pascal problem with approximate spectra preconditioner' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/real_sp_testing.results/vandermonde_1a/real_sp_apc_driver1a.out' >> ../testing.summary
...
echo 'solve pascal problem with davidson preconditioner' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/real_sp_testing.results/vandermonde_1a/real_sp_dpc_driver1a.out' >> ../testing.summary
...
echo '' >> ../testing.summary
echo '~~~~~Real Single pascal_a test done~~~~~'
