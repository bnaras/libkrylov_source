...
rm *.save
echo '4' | ../../../src/real_sp_test/test_restart_c_real_sp > real_sp_c_restart_k.out
echo '' >> ../testing.summary
rm kill.libkrylov
mv real_sp_c_restart_0.out real_sp_c_restart_0.out.old
...
echo '1' | ../../../src/real_sp_test/test_restart_c_real_sp > real_sp_c_restart_0.out
echo '' >> ../testing.summary
rm real_sp_1c_lagr.json
rm real_sp_1c_vecs.json
rm real_sp_1c_indx.json
mv real_sp_c_restart_1.out real_sp_c_restart_1.out.old
echo 'restart level 1' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/real_sp_testing.results/restart_c/real_sp_c_restart_1.out' >> ../testing.summary
echo '1' | ../../../src/real_sp_test/test_restart_c_real_sp > real_sp_c_restart_1.out
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv real_sp_c_restart_2.out real_sp_c_restart_2.out.old
echo 'restart level 2' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/real_sp_testing.results/restart_c/real_sp_c_restart_2.out' >> ../testing.summary
echo '2' | ../../../src/real_sp_test/test_restart_c_real_sp > real_sp_c_restart_2.out
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv real_sp_c_restart_3.out real_sp_c_restart_3.out.old
echo 'restart level 3' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/real_sp_testing.results/restart_c/real_sp_c_restart_3.out' >> ../testing.summary
echo '3' | ../../../src/real_sp_test/test_restart_c_real_sp > real_sp_c_restart_3.out
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv real_sp_c_restart_4.out real_sp_c_restart_4.out.old
echo 'restart level 4' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/real_sp_testing.results/restart_c/real_sp_c_restart_4.out' >> ../testing.summary
echo '4' | ../../../src/real_sp_test/test_restart_c_real_sp > real_sp_c_restart_4.out
