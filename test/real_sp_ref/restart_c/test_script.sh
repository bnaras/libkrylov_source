...
grep 'Final L' real_sp_c_restart_1.out >> ../testing.summary
...
grep 'Final L' real_sp_c_restart_2.out >> ../testing.summary
echo 'error statments:' >> ../testing.summary
...
grep 'Final L' real_sp_c_restart_3.out >> ../testing.summary
echo 'error statments:' >> ../testing.summary
...
grep 'Final L' real_sp_c_restart_4.out >> ../testing.summary
echo 'error statments:' >> ../testing.summary
