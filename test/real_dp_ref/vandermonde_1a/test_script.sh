...
echo ' libkrylov/src/real_dp_test/problem1a_vm_real_dp' >> ../testing.summary
../../../src/real_dp_test/problem1a_vm_real_dp
...
echo 'test/real_dp_testing.results/vandermonde_1a/real_dp_npc_driver1a.out' >> ../testing.summary
...
echo 'test output in' >> ../testing.summary
echo 'test/real_dp_testing.results/vandermonde_1a/real_dp_apc_driver1a.out' >> ../testing.summary
...
echo 'test output in' >> ../testing.summary
echo 'test/real_dp_testing.results/vandermonde_1a/real_dp_dpc_driver1a.out' >> ../testing.summary
...
echo '' >> ../testing.summary
echo '~~~~~Real Single vandermonde_a test done~~~~~'
