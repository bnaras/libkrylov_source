...
echo ' libkrylov/src/real_dp_test/problem1b_rand_real_dp' >> ../testing.summary
echo 'at zero frequency'  >> ../testing.summary
../../../src/real_dp_test/problem1b_rand_real_dp
echo 'comparing to exact solutions' >> ../testing.summary
sed '7,11!d' real_dp_1b_exact_lagr.json >> ../testing.summary
echo '' >> ../testing.summary
...
echo 'none' | ../../../src/real_dp_test/driver1b_real_dp > real_dp_npc_driver1b.out
mv real_dp_1b_lagr.json real_dp_1b_npc_lagr.json
...
sed '7,11!d' real_dp_1b_npc_lagr.json >> ../testing.summary
echo '' >> ../testing.summary
...
echo 'approx_spectra' | ../../../src/real_dp_test/driver1b_real_dp > real_dp_apc_driver1b.out
mv real_dp_1b_lagr.json real_dp_1b_apc_lagr.json
...
echo 'eigenvalues' >> ../testing.summary
sed '7,11!d' real_dp_1b_apc_lagr.json >> ../testing.summary
echo '' >> ../testing.summary
echo '~~~~~Real Double random_b test done~~~~~'
