...
echo 'using libkrylov/src/real_dp_test/test_restart_c_real_dp'  >> ../testing.summary
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv real_dp_c_restart_0.out real_dp_c_restart_0.out.old
...
rm real_dp_1c_vecs.json
rm real_dp_1c_indx.json
mv real_dp_c_restart_1.out real_dp_c_restart_1.out.old
echo 'restart level 1' >> ../testing.summary
echo 'test output in' >> ../testing.summary
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv real_dp_c_restart_2.out real_dp_c_restart_2.out.old
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv real_dp_c_restart_3.out real_dp_c_restart_3.out.old
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv real_dp_c_restart_4.out real_dp_c_restart_4.out.old
