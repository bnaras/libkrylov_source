...
../../../src/real_dp_test/driver1a_real_dp -irestart 4 > real_dp_a_restart_k.out
echo '' >> ../testing.summary
rm kill.libkrylov
mv real_dp_a_restart_0.out real_dp_a_restart_0.out.old 2>/dev/null
...
mv real_dp_a_restart_1.out real_dp_a_restart_1.out.old 2>/dev/null
echo 'restart level 1' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/real_dp_testing.results/restart_a/real_dp_a_restart_1.out' >> ../testing.summary
../../../src/real_dp_test/driver1a_real_dp -irestart 1 > real_dp_a_restart_1.out
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv real_dp_a_restart_2.out real_dp_a_restart_2.out.old 2>/dev/null
echo 'restart level 2' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/real_dp_testing.results/restart_a/real_dp_a_restart_2.out' >> ../testing.summary
../../../src/real_dp_test/driver1a_real_dp -irestart 2 > real_dp_a_restart_2.out
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv real_dp_a_restart_3.out real_dp_a_restart_3.out.old 2>/dev/null
echo 'restart level 3' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/real_dp_testing.results/restart_a/real_dp_a_restart_3.out' >> ../testing.summary
../../../src/real_dp_test/driver1a_real_dp -irestart 3 > real_dp_a_restart_3.out
