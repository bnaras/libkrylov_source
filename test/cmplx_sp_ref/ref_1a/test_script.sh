...
echo '' >> ../testing.summary
mv cmplx_sp_spc_driver1a.out cmplx_sp_spc_driver1a.out.old
...
echo 'sleijpen' | ../../../src/cmplx_sp_test/driver1a_cmplx_sp > cmplx_sp_spc_driver1a.out
...
echo '' >> ../testing.summary
echo '~~~~~Complex Single reference tests done~~~~~'
