...
mv cmplx_sp_npc_driver1a.out cmplx_sp_npc_driver1a.out.old 2>/dev/null
echo 'solve reference problem with no preconditioner' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/cmplx_sp_testing.results/ref_1a/cmplx_sp_npc_driver1a.out' >> ../testing.summary
../../../src/cmplx_sp_test/driver1a_cmplx_sp -precon none > cmplx_sp_npc_driver1a.out
...
echo 'test output in' >> ../testing.summary
echo 'test/cmplx_sp_testing.results/ref_1a/cmplx_sp_dpc_driver1a.out' >> ../testing.summary
../../../src/cmplx_sp_test/driver1a_cmplx_sp -precon davidson > cmplx_sp_dpc_driver1a.out
...
echo 'test output in' >> ../testing.summary
echo 'test/cmplx_sp_testing.results/ref_1a/cmplx_sp_spc_driver1a.out' >> ../testing.summary
../../../src/cmplx_sp_test/driver1a_cmplx_sp -precon sleijpen > cmplx_sp_spc_driver1a.out
