...
echo ' libkrylov/src/cmplx_sp_test/problem1a_rand_cmplx_sp' >> ../testing.summary
../../../src/cmplx_sp_test/problem1a_rand_cmplx_sp
#echo 'comparing to exact solutions' >> ../testing.summary
#sed '7,11!d' cmplx_sp_1a_exact_vals.raft >> ../testing.summary
echo '' >> ../testing.summary
...
echo 'test/cmplx_sp_testing.results/random_1a/cmplx_sp_npc_driver1a.out' >> ../testing.summary
...
echo 'test output in' >> ../testing.summary
echo 'test/cmplx_sp_testing.results/random_1a/cmplx_sp_apc_driver1a.out' >> ../testing.summary
...
echo 'test output in' >> ../testing.summary
echo 'test/cmplx_sp_testing.results/random_1a/cmplx_sp_dpc_driver1a.out' >> ../testing.summary
...
echo '' >> ../testing.summary
echo '~~~~~Complex Single random_a test done~~~~~'
