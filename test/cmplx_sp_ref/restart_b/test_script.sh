...
grep 'Final L' cmplx_sp_b_restart_1.out >> ../testing.summary
...
grep 'Final L' cmplx_sp_b_restart_2.out >> ../testing.summary
echo 'error statments:' >> ../testing.summary
...
grep 'Final L' cmplx_sp_b_restart_3.out >> ../testing.summary
echo 'error statments:' >> ../testing.summary
...
grep 'Final L' cmplx_sp_b_restart_4.out >> ../testing.summary
echo 'error statments:' >> ../testing.summary
