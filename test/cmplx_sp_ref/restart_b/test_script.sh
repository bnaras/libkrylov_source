...
echo '1' | ../../../src/cmplx_sp_test/test_restart_b_cmplx_sp > cmplx_sp_b_restart_0.out
echo '' >> ../testing.summary
rm cmplx_sp_1b_lagr.json
rm cmplx_sp_1b_vecs.json
...
echo '1' | ../../../src/cmplx_sp_test/test_restart_b_cmplx_sp > cmplx_sp_b_restart_1.out
...
echo '2' | ../../../src/cmplx_sp_test/test_restart_b_cmplx_sp > cmplx_sp_b_restart_2.out
...
echo '3' | ../../../src/cmplx_sp_test/test_restart_b_cmplx_sp > cmplx_sp_b_restart_3.out
