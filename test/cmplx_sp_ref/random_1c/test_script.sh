...
echo ' libkrylov/src/cmplx_sp_test/problem1c_rand_cmplx_sp' >> ../testing.summary
../../../src/cmplx_sp_test/problem1c_rand_cmplx_sp
echo 'comparing to exact solutions' >> ../testing.summary
echo 'grouped by frequency:' >> ../testing.summary
sed '7,8!d' cmplx_sp_1c_freq.json >> ../testing.summary
...
mv cmplx_sp_npc_driver1c.out cmplx_sp_npc_driver1c.out.old
echo 'solve random problem with no preconditioner' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/cmplx_sp_testing.results/random_1c/cmplx_sp_npc_driver1c.out' >> ../testing.summary
...
echo '' >> ../testing.summary
mv cmplx_sp_apc_driver1c.out cmplx_sp_apc_driver1c.out.old
echo 'solve random problem with approximate spectra preconditioner' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/cmplx_sp_testing.results/random_1c/cmplx_sp_apc_driver1c.out' >> ../testing.summary
...
echo '' >> ../testing.summary
mv cmplx_sp_dpc_driver1c.out cmplx_sp_dpc_driver1c.out.old
echo 'solve random problem with davidson preconditioner' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/cmplx_sp_testing.results/random_1c/cmplx_sp_dpc_driver1c.out' >> ../testing.summary
...
echo '' >> ../testing.summary
echo '~~~~~Complex Single random_c test done~~~~~'
