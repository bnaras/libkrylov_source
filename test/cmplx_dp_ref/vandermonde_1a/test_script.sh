...
echo ' libkrylov/src/cmplx_dp_test/problem1a_vm_cmplx_dp' >> ../testing.summary
../../../src/cmplx_dp_test/problem1a_vm_cmplx_dp
...
echo 'test/cmplx_dp_testing.results/vandermonde_1a/cmplx_dp_npc_driver1a.out' >> ../testing.summary
...
echo 'test output in' >> ../testing.summary
echo 'test/cmplx_dp_testing.results/vandermonde_1a/cmplx_dp_apc_driver1a.out' >> ../testing.summary
...
echo 'test output in' >> ../testing.summary
echo 'test/cmplx_dp_testing.results/vandermonde_1a/cmplx_dp_dpc_driver1a.out' >> ../testing.summary
...
echo '' >> ../testing.summary
echo '~~~~~Complex Double vandermonde_a test done~~~~~'
