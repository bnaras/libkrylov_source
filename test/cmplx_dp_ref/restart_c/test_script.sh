...
echo '' >> ../testing.summary
rm kill.libkrylov
mv cmplx_dp_c_restart_0.out cmplx_dp_c_restart_0.out.old 2>/dev/null
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv cmplx_dp_c_restart_2.out cmplx_dp_c_restart_2.out.old 2>/dev/null
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv cmplx_dp_c_restart_3.out cmplx_dp_c_restart_3.out.old 2>/dev/null
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv cmplx_dp_c_restart_4.out cmplx_dp_c_restart_4.out.old 2>/dev/null
