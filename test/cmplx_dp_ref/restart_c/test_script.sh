...
echo 'using libkrylov/src/cmplx_dp_test/test_restart_c_cmplx_dp'  >> ../testing.summary
...
echo 'test/cmplx_dp_testing.results/restart_c/cmplx_dp_c_restart_k.out' >> ../testing.summary
touch kill.libkrylov
rm *.save
echo '4' | ../../../src/cmplx_dp_test/test_restart_c_cmplx_dp > cmplx_dp_c_restart_k.out
echo '' >> ../testing.summary
rm kill.libkrylov
mv cmplx_dp_c_restart_0.out cmplx_dp_c_restart_0.out.old
...
echo '1' | ../../../src/cmplx_dp_test/test_restart_c_cmplx_dp > cmplx_dp_c_restart_0.out
echo '' >> ../testing.summary
rm cmplx_dp_1c_lagr.json
rm cmplx_dp_1c_vecs.json
rm cmplx_dp_1c_indx.json
mv cmplx_dp_c_restart_1.out cmplx_dp_c_restart_1.out.old
echo 'restart level 1' >> ../testing.summary
echo 'test output in' >> ../testing.summary
echo 'test/cmplx_dp_testing.results/restart_c/cmplx_dp_c_restart_1.out' >> ../testing.summary
echo '1' | ../../../src/cmplx_dp_test/test_restart_c_cmplx_dp > cmplx_dp_c_restart_1.out
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv cmplx_dp_c_restart_2.out cmplx_dp_c_restart_2.out.old
...
echo '2' | ../../../src/cmplx_dp_test/test_restart_c_cmplx_dp > cmplx_dp_c_restart_2.out
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv cmplx_dp_c_restart_3.out cmplx_dp_c_restart_3.out.old
...
echo '3' | ../../../src/cmplx_dp_test/test_restart_c_cmplx_dp > cmplx_dp_c_restart_3.out
...
echo '' >> ../testing.summary
rm kill.libkrylov
mv cmplx_dp_c_restart_4.out cmplx_dp_c_restart_4.out.old
...
echo '4' | ../../../src/cmplx_dp_test/test_restart_c_cmplx_dp > cmplx_dp_c_restart_4.out
